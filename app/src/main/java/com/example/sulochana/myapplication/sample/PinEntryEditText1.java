...
public class PinEntryEditText1 extends AppCompatEditText {
    ...
    protected  OnFocusChangeListener mfocusListener;
    ...
    public PinEntryEditText1(Context context) {
        super(context);
    }

    public PinEntryEditText1(Context context, AttributeSet attrs) {
        super(context, attrs);
        c=context;
        init(context, attrs);
    }

    public PinEntryEditText1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void animatePopIn() {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                PinEntryEditText1.this.invalidate();
            }
        });
